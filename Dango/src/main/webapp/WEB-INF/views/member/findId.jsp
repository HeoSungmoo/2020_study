		...
		$.ajax({
			...
			success : function(data){
				if(data == "X"){
					...
					$.ajax({
						url : '${path}/member/mailIdSend',
						type : 'post',
						data : 'mail='+mail+'&id='+data,
						success : function(data){
							location.href="${path}/member/findIdSuccess.do";
						}
					})
				}
			}
...
<form class="form-horizontal">
	...
	<div class="form-group">
		<div class="col-lg-10">
			<input type="button" class="btn btn-primary btn-block btn-lg" id="findIdBtn" value="찾기">
			<p id="findIdCheck" style="color:red">입력하신 정보가 틀립니다.</p>
		</div>
	</div>
</form>
